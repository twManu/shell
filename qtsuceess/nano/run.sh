...
#nano test
./configure -shared -c++std c++14 -opensource -release -recheck-all --confirm-license -device linux-jetson-tx1-g++ -device-option CROSS_COMPILE=aarch64-linux-gnu- -sysroot / -nomake examples -nomake tests -prefix /usr/lib/qt5.14.1 -extprefix /home/manu/Documents/qt5 -hostprefix /home/manu/Documents/qt5-host -skip webview -skip qtwebengine -opengl es2
